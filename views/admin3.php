...
<head><
	...
	<link rel="stylesheet" type="text/css" href="as/css/status.css">
  <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width,initial-scale=1">
    <title>Admin Elemento</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="as/assets/images/favicon.png">
    <!-- Custom Stylesheet -->
    <link href="as/assets/plugins/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
    <link href="as/main/css/style.css" rel="stylesheet">
        ...
        <div class="nav-header">
            <div class="brand-logo">
                <a href="index.html">
                    ...
                    <span class="brand-title"><b>Elemento</b></span>
                </a>
            </div>
                    ...
                    <ul class="clearfix">
                                    ...
                                    <ul>
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="as/assets/images/avatar/1.jpg" alt="avatar">
                                        ...
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="as/assets/images/avatar/2.jpg" alt="avatar">
                                                <div class="notification-content">
                                                    <div class="notification-timestamp">08 Hours ago</div>
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="as/assets/images/avatar/3.jpg" alt="avatar">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="as/assets/images/avatar/4.jpg" alt="avatar">
                                                <div class="notification-content">
                        ...
                        <li class="icons">
                            <div class="user-img c-pointer-x">
                                ...
                                <img src="as/assets/images/avatar/elemento2.jpg" height="40" width="40" alt="avatar">
                            </div>
                            <div class="drop-down dropdown-profile animated flipInX">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <li><a href="javascript:void()"><i class="icon-envelope-open"></i> <spanf>My Inbox</span> <div class="badge gradient-3 badge-pill badge-primary">3</div></a>
                                        </li>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="admin">elemento</a></li>
                            
                            
                           
                            <li><a href="admin1">Offer</a></li>
                            
                            
                            <li><a href="admin2">Custommer</a></li>
                            <li><a href="admin3">EXP</a></li>
                    ...
                    <li>
                        <ul aria-expanded="false">
                            ...
                            <li><a href="admin4">Profile</a></li>
                            
                        </ul>
                    </li>
                    <li class="nav-label"><hr></li>
                        <ul aria-expanded="false">
                            <li><a href="admin5">Login</a></li>
                            
                            <li><a href="admin6">Lock Screen</a></li>
            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="breadcrumb-range-picker">
                        ...
                        <span class="ml-1">November 19, 2020</span>
                    </div>
                </div>
	...
	<div id="utama">
		<div id="awal">
			<div id="destra">
				...
				<div id="tengah">
					<p>EXP Bahan-Bahan resto</p>
				</div>
				<div id="kacau">
					<p>Status expied resto bisa di lihat disamping sebagai berikut</p>
				</div>
			</div>
		</div>
		<div id="dua">
		...
		<div id="tiga">
			...
			<div id="dalamsatuuuuu">
				
			</div>
			<div id="dalamsatuuuuuu">
				
			</div>
			<div id="dalamsatuuuuuuu">
				
			</div>
			<div id="dalamsatuuuuuuuu">
